...
class FlexLexerTest {
    @Test
    fun testTokens(){
        val src = FileUtil.loadFile(File("src/test/resources/org/hoggar/lang/lexer/flextokens.txt"))
        println(src)
        ...
        val exp = FileUtil.loadFile(File("src/test/resources/org/hoggar/lang/lexer/expected_token_types.txt"))
